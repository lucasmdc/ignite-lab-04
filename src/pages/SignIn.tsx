...
export function SignIn() {
  ...
  return (
    <div className='w-screen h-screen flex flex-col bg-gray-900 flex items-center justify-center text-gray-100'>
      ...
      <form onSubmit={handleSignIn} className='flex flex-col gap-3 items-stretch w-full max-w-sm mt-10'>
        {isUserSignIn ? <Text>Login Realizado!</Text> : null}
        <label htmlFor='email' className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input id='email' name='email' type='email' placeholder='Digite seu e-mail' />
          </TextInput.Root>
        </label>
